...
function getDefaultStageSeeds(workspaceId: string): WorkspaceStageSeed[] {
  ...
  return [
    ...
    { slug: 'WAITING_CANDIDATE', labelEs: 'Esperando candidato', order: 25 },
    ...
    { slug: 'INTERVIEW_SCHEDULED', labelEs: 'Entrevista agendada', order: 60 },
    { slug: 'RECRUIT_COMPLETE', labelEs: 'Listo para revisar', order: 65 },
    // Pipeline genérico (útil para clientes tipo SSClinical u otros verticales).
    { slug: 'INTERESADO', labelEs: 'Interesado', order: 70 },
    { slug: 'EN_COORDINACION', labelEs: 'En coordinación', order: 72 },
    { slug: 'AGENDADO', labelEs: 'Agendado', order: 74 },
    { slug: 'COMPLETADO', labelEs: 'Completado', order: 80, isTerminal: true },
    { slug: 'HIRED_DRIVER', labelEs: 'Contratado', order: 82, isTerminal: true },
    { slug: 'REJECTED', labelEs: 'Rechazado', order: 90, isTerminal: true },
    { slug: 'DISQUALIFIED', labelEs: 'No califica', order: 92, isTerminal: true },
    { slug: 'STALE_NO_RESPONSE', labelEs: 'Sin respuesta', order: 94, isTerminal: true },
    { slug: 'NO_CONTACTAR', labelEs: 'No contactar', order: 95, isTerminal: true },
    { slug: 'ARCHIVED', labelEs: 'Archivado', order: 99, isTerminal: true },
  ];
}
